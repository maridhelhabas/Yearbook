        ...
        <div class="col-lg-2 col-xl-8" style=" position: fixed; width:80%; height: 50%; margin-top: 28%;margin-left: 250px;margin-right: 10px;">
          <div class="card shadow mt-2">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
              <h3 class="text-primary">View Yearbook Template</h3>
...
<div class="modal fade " id="addstaffModal" tabindex="-1" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content dash-blade">
      ...
      <form action="{{ route('template.store') }}" method="POST" id="add_staff_form">
        @csrf
        <div class="modal-body dash-blade p-4 bg-light">
          ...
          <div class="my-2">
            ...
            <input type="number"  name="temp_usage" class="form-control form-control2 @error('temp_usage') is-invalid @enderror" placeholder="usage" required>
            @error('temp_usage')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
...
let table = $('#example').DataTable({
    ajax: {
        url: '{{ route('template.fetch_template') }}',
        method: 'GET',
    ...
    columns: [
        ...
        // }
        {
            ...
            render: function(data, type, row) {
              var staffId = row.id;
              var staffFirstName = row.template_name;
              var staffLastName = row.template_status;
              var staffEmail = row.template_usage;
