...
<body>
        ...
        <div class="col-lg-2 col-xl-8" style=" position: fixed; width:80%; height: 50%; margin-top: 28%;margin-left: 250px;margin-right: 10px;">
          <div class="card shadow mt-2">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
              ...
              <button class="btn btn-warning text-white" data-bs-toggle="modal" data-bs-target="#addreportsModal" ><i
    ...
    {{-- add new record modal start --}}
<div class="modal fade " id="addreportsModal" tabindex="-1" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content" style=" background-color: #DCDCDC;">
      <div class="modal-header" style=" background-color: #DCDCDC;">
        <h5 class="modal-title" id="exampleModalLabel">Record yearbook</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="{{ route('staff.store') }}" method="POST" id="add_reports_form" enctype="multipart/form-data">
        @csrf
        <div class="modal-body p-4" style=" background-color: #DCDCDC;">
          <div class="row">
            ...
            <div class="col-lg">
              <label for="report_id" class="text-dark">{{ __(' ID') }}</label>
              <input type="number" name="report_id" class="form-control form-control2" id="add_report_id" value="{{ old('report_id') }}" required readonly>
              
            </div>
          </div>
         <div class="my-2">
            <label for="batch" class="text-dark">{{ __('Batch') }} <span class="text-danger">*</span></label>
            <input type="number" name="batch" class="form-control form-control2" placeholder="Enter Batch" required>
            @error('batch')
          ...
          <div class="my-2">
            <label for="date" class="text-dark">{{ __('Date') }} <span class="text-danger">*</span></label>
            <input type="date" name="date" class="form-control form-control2" placeholder="Enter Date" required>
            @error('date')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
           ...
           <div class="my-2">
            <label for="status" class="text-dark">{{ __('Status') }} <span class="text-danger">*</span></label>
            <input type="text" name="status" class="form-control form-control2" placeholder="Enter Status" required>
            @error('status')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="modal-footer">
          ...
          <button type="submit"  class="btn btn-primary d-grip gap-2" style="width: 30%; border-color:white">Add</button>
        </div>
      </form>
    </div>
  </div>
</div>
{{-- add new record modal end --}}
      ...
      <form action="{{ route('staff.update', 'formAction') }}" method="POST"  enctype="multipart/form-data">
        ...
        <div class="modal-body dash-blade p-4 bg-light">
          ...
          <div class="my-2">
            ...
            <input type="number"  name="phone_number" class="form-control form-control2 @error('phone_number') is-invalid @enderror" placeholder="phone number" id="staff_phone_no" required>
            @error('phone_number')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
