...
<head>
    ...
    .p1 {
        ...
        nav {
            ...
            background-image: linear-gradient(to right,#0039A6,#000080, #4169E1, #E0FFFF);
        }
        .active{
...
<body>
    <div>
        <nav class="navbar navbar-expand-md navbar-light bg-nav shadow-sm">
            <div>
                <img src="ceclogo.png" class="container rounded mx-auto d-inline-block float-left" alt="hugenerd" width="60" height="60">
            </div>
    ...
    <div class="col py-1">
                <p class="lead text-danger text-center mb-5"><h2 class="text-center">Design</h2></p>
