...
<body style="background-image: url('{{ asset('bg.png') }}'); background-size: cover; 
...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-1">
                <p class="lead text-danger text-center mb-5"><h2 class="text-center">REGISTRATION PAGE</h2></p>
